...
const NavBar = () => {
  ...
  const ethBalance = useEtherBalance(config.addresses.sportsManagerDaoExecutor);
  const lidoBalanceAsETH = useLidoBalance();
  const treasuryBalance = ethBalance && lidoBalanceAsETH && ethBalance.add(lidoBalanceAsETH);
  const daoEtherscanLink = buildEtherscanHoldingsLink(config.addresses.sportsManagerDaoExecutor);
